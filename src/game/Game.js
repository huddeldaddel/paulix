...
var Game = React.createClass({
    ...
    checkCollision: function (actor, object) {
        var objectRect;
    ...
    drawControls: function() {
        ...
        this.ctx.fillText("Zeit: " + timeRemaining, this.size.tile.target.w, this.size.tile.target.h);
        this.ctx.fillText("Geld: " + GameStore.coins, this.size.tile.target.w +150, this.size.tile.target.h);
        this.ctx.fillText("Punkte: " + GameStore.score, this.size.tile.target.w +350, this.size.tile.target.h);
        this.ctx.fillText(GameStore.lives + " Leben", this.size.canvas.w - 3 * this.size.tile.target.w -50, this.size.tile.target.h);
    },
    ...
    replaceLevelSpriteXY: function(x, y, item) {
    ...
    getLevelSpritePositions: function(type) {
        var self = this;
        var positions = []
    ...
    getLastLevelSpritePosition: function(type, x) {
        var pos;
